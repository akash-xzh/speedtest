...
> by Federico Dossena
> Version 5.4.1
> [https://vyturex.com/](https://vyturex.com/)

## Introduction

UrSpeeD is a Free and Open Source speed test that you can host on your server(s), and users can run in their browser.
...
If your list of servers changes often, you might not want to have it hardcoded in the HTML file. UrSpeeD can load the server list from a JSON file. To do this, remove the server list and replace it with the URL to your server list, like this:
